...
export default function TodoList() {
  ...
  return (
    <div className="relative max-w-4xl mx-auto p-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
      <DotPattern
        width={40}
        height={40}
        cx={1}
        cy={1}
        cr={1}
        className="absolute inset-0 h-full w-full text-gray-200 dark:text-gray-700 opacity-30"
      />
